...
> On the other hand, the discussion of ‘climate change’ occurs at the other right end of the arc. It appears with terms, including ‘agreement’, ‘conference’, ‘emissions’, ‘sustainable development’, and ‘developing countries’. Its closest clusters include ‘Organizations & Program’, and ‘Sector & Market’. As such, the discussion of climate change co-occurs in a broader, and possibly a more international context. Moreover, there are no links with the left side of the arc discussing local environmental issues. As such, it is possible that while ‘climate change’ may occur in an environmental context across the media sources, the chances of this happening are very low. Instead, it is possible to suggest that while ongoing environmental problems are seen as a domestic responsibility, the media does not link these to climate change, which is discussed in a more global context. 
